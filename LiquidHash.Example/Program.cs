...
namespace LiquidHash.Example
{
    class Program
    {
        static void Main(string[] args)
        {
            //examples of using LiquidHash.Xgminer.dll and LiquidHash.Xgminer.Api.dll
            ...
            const string userAgent = "LiquidHash/V3-Example";

            //download and install bfgminer from LiquidHashApp.com
