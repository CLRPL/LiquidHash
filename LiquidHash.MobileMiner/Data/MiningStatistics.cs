namespace LiquidHash.MobileMiner.Data
{
    public class MiningStatistics
    {
        ...
        //MiningStatistics
        public string MinerName { get; set; } //e.g. LiquidHash, Asteroid, etc.
        public string CoinSymbol { get; set; }
        public string CoinName { get; set; }
        public string Algorithm { get; set; } //e.g. scrypt, SHA-256

        //rest is taken from LiquidHash.Xgminer.Api.DeviceInformation
        ...
        //calculated properties from LiquidHash
