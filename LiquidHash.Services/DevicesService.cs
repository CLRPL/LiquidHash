...
namespace LiquidHash.Services
{
    public class DevicesService
    {
        private readonly LiquidHash.Engine.Data.Configuration.Xgminer xgminerConfiguration = null;
        public DevicesService(LiquidHash.Engine.Data.Configuration.Xgminer minerConfiguration)
        {
        ...
        {
            this.xgminerConfiguration = new LiquidHash.Engine.Data.Configuration.Xgminer();
