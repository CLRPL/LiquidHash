...
namespace LiquidHash.Utility.Networking.Tests
{
    [TestClass]
    public class LocalNetworkTests
    {
        ...
        {
            System.Collections.Generic.List<LiquidHash.Utility.Net.LocalNetwork.NetworkInterfaceInfo> localNetworkInterfaces = null;
