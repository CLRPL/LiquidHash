...
{
    public class LiquidHashInstaller
    {
        ...
        public static void InstallMiner(string destinationFolder)
        {
            ...
            if (!String.IsNullOrEmpty(minerUrl))
            {
                ...
                try
                {
                    ...
                    {
                        //extract LiquidHash.Update.exe from the zip file, run it, and exit
                        ...
                        string updaterFilePath = Path.Combine(temporaryFolder, "LiquidHash.Update.exe");
        ...
        private static string GetMinerDownloadUrl()
        {
            ...
            const string filePrefix = "LiquidHash";

            string pattern = String.Format(@".*<a href="".+/LiquidHash/releases/(.+/{0}-\d+\.\d+\.\d+\.zip)", filePrefix);
        ...
        public static string GetMinerDownloadRoot()
        {
            ...
            return "https://github.com/nwoolls/LiquidHash";
        }
    }
}
