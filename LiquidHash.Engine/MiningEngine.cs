        ...
        private void LaunchProxyMiners(int apiPort)
        {
            ...
            foreach (Xgminer.Data.Device proxyDevice in proxyDevices)
            {
                ...
                if (minerConfiguration != null)
                {
                    ...
                    LiquidHash.Engine.Data.Configuration.Xgminer.ProxyDescriptor proxyDescriptor = engineConfiguration.XgminerConfiguration.StratumProxies[index];
