...
namespace LiquidHash.Xgminer.Api.Parsers
{
    class VersionInformationParser : ResponseTextParser
    {
        public static void ParseTextForVersionInformation(string text, LiquidHash.Xgminer.Api.Data.VersionInformation versionInformation)
        {
