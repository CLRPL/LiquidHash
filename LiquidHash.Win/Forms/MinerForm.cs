...
//using LiquidHash.MobileMiner.Embed;
...
using LiquidHash.Win.Controls;
using LiquidHash.Win.Controls.Notifications;
using LiquidHash.Win.Forms.Configuration;
...
namespace LiquidHash.Win.Forms
{
    public partial class MinerForm : MessageBoxFontForm
    {
        ...
        private void SetNotificationAreaHint()
        {
            ...
            string bubbleText = string.Format("LiquidHash - {0}", hashRateStatusLabel.Text);
        ...
        private bool ShouldQuickSwitchAllRigs(string coinSymbol)
        {
            ...
            if (app.RemotingEnabled && (app.InstanceManager.Instances.Count > 1))
            {
                DialogResult dialogResult = MessageBox.Show(
                    ...
                    @"LiquidHash Remoting", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (dialogResult == DialogResult.Yes)
                    allRigs = true;
            }
            return allRigs;
        ...
        {
            Process.Start("https://github.com/nwoolls/LiquidHash/wiki");
        }
        ...
        private void SetupApplication()
        {
            ...
            //app.SubmitLiquidHashStatistics();
        ...
        private void ShowNotInstalledMinerWarning()
        {
            ...
            if (showWarning)
                MessageBox.Show(@"No copy of " + MinerNames.BFGMiner + @" was detected. Please go to https://github.com/nwoolls/LiquidHash for instructions on installing " + MinerNames.BFGMiner + @".",
        ...
        private void ShowBalloonNotification(string text, Action clickHandler, ToolTipIcon icon)
        {
            ...
            notifyIcon1.BalloonTipTitle = @"LiquidHash";
