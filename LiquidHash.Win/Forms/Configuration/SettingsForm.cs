using LiquidHash.MobileMiner.Helpers;
...
namespace LiquidHash.Win.Forms.Configuration
{
    ...
    {
        private readonly LiquidHash.Engine.Data.Configuration.Xgminer minerConfiguration;
        ...
        public SettingsForm(UX.Data.Configuration.Application applicationConfiguration, LiquidHash.Engine.Data.Configuration.Xgminer minerConfiguration,
        ...
        {
            Process.Start("https://github.com/nwoolls/LiquidHash/wiki/Settings");
        }
