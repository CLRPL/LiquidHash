...
using LiquidHash.Engine.Extensions;
...
namespace LiquidHash.Win.Forms.Configuration
{
    public partial class MinerSettingsForm : MessageBoxFontForm
    {
        ...
        private readonly LiquidHash.Engine.Data.Configuration.Xgminer workingMinerConfiguration;
        ...
        {
            Process.Start("https://github.com/nwoolls/LiquidHash/wiki/Settings#advanced-miner-settings");
        }
    }
}
