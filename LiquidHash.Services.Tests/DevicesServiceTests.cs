...
namespace LiquidHash.Services.Tests
{
    [TestClass]
    public class DevicesServiceTests
    {
        ...
        public static void MyClassInitialize(TestContext testContext)
        {
            ...
            string minersDirectory = Path.Combine(Path.Combine(Path.Combine(Path.Combine(solutionDirectory, "LiquidHash.Win"), "bin"), "debug"), "Miners");
