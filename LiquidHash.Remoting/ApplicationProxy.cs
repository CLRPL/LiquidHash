...
namespace LiquidHash.Remoting
{
    public sealed class ApplicationProxy
    {
        ...
        public event RemoteEventHandler UpgradeLiquidHashRequested;
        ...
        public void UpgradeLiquidHash(RemotingService sender, string clientAddress, string signature)
        {
            if (UpgradeLiquidHashRequested != null)
                UpgradeLiquidHashRequested(sender, new RemoteCommandEventArgs { IpAddress = clientAddress, Signature = signature });
        }
