...
namespace LiquidHash.Remoting
{
    ...
    public class RemotingService : IRemotingService
    {
        ...
        private static string GetClientIpAddress()
        {
            ...
            if (LiquidHash.Utility.OS.OSVersionPlatform.GetGenericPlatform() == System.PlatformID.Unix)
        ...
        public void UpgradeLiquidHash(string signature)
        {
            ApplicationProxy.Instance.UpgradeLiquidHash(this, GetClientIpAddress(), signature);
        }
